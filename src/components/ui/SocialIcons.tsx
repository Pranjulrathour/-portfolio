    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/pranjul-rathour?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/Pranjulrathour" target="_blank" rel="noopener noreferrer" aria-label="GitHub" data-social="github">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a href="https://www.instagram.com/pranjulrathour.in?igsh=MTl6Y3B6andqN2wwMw==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" data-social="instagram">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a href="https://www.youtube.com/@pranjulrathour.i" target="_blank" rel="noopener noreferrer" aria-label="Youtube" data-social="youtube">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a href="https://x.com/PranjulRathourx" target="_blank" rel="noopener noreferrer" aria-label="X" data-social="x">
            <div className="filled" />
            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" viewBox="0 0 16 16" xmlSpace="preserve">
